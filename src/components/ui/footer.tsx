...
export const Footer = () => {
  return (
    <footer className='z-10 w-full  items-center justify-between font-mono text-sm footer-bg pt-10'>
      <Grid templateColumns={{ base: "3fr", md: "1fr 1fr 1fr" }} p={6} justifyContent="space-between">
        <GridItem>
          <Box>
        ...
        <GridItem className='text-center hide-mobile'>
          <Box >
        ...
        <GridItem className='text-right hide-mobile	'>
          <Box>
      ...
      <Grid templateColumns={{ base: "2fr", md: "1fr 1fr" }} p={6} justifyContent="space-between" className='pt-10'  >
        <GridItem >
          <Box>
            <Flex align="center" wrap="wrap" display={'flex'}>
